...
let url = playgroundSharedDataDirectory.appendingPathComponent("somefile.txt4", isDirectory: false)
let fileUrl = Bundle.main.url(forResource: "somefile", withExtension: "txt12")!
